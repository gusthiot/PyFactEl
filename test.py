...
dossier_data = dossier_travail + Outils.separateur(plateforme) + "test" + Outils.separateur(plateforme)
...
dossier_enregistrement = Outils.dossier_enregistrement(dossier_data, edition.annee, edition.mois,
                                                        plateforme)
